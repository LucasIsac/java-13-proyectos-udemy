...
<div class="container">
    <div class="texte-center" style="margin : 30px">
    ...
    <input type="hidden" name="idEmpleado" value="${empleado.idEmpleado}"/>
        <div class="mb-3">
            ...
            <input type="texto" class="form-control" id="nombreEmpleado" name="nombreEmpleado" required="true" value="${empleado.nombreEmpleado}">
        </div>
        <div class="mb-3">
